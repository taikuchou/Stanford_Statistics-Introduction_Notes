# Hypothesis Testing
*(Hypothesis Testing, Test Statistics, p-Values, t-Tests, Two-Sample Tests, Matched Pairs, and Practical Significance)*
...
Test statistic:
\[
Z = \frac{\text{Observed difference} - 0}{\text{SE of the
